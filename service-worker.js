var CACHE_VERSION = "ei-trazabilidad-v145-superadmin-delete-stickers-recepcion";
var APP_SHELL = ["./","./index.html","./styles.css","./app.js","./firebase-config.js","./vsm-dashboard.html","./vsm-dashboard.js","./manifest.json","./assets/logo-electroingenieria.jpeg","./assets/app-icon.svg","./assets/sounds/universfield-new-notification-051-494246.mp3","./assets/sounds/te-llego-un-requerimiento.mp3","./assets/sounds/te-llego-un-reporte.mp3","./assets/sounds/tu-pedido-lleva-mas.mp3","./assets/sounds/tienes-un-nuevo-pedido.mp3","./assets/sounds/han-cerrado-tu-pedido.mp3","./assets/sounds/haz-cerrado-el-caso.mp3","./assets/sounds/haz-creado-un-requerimiento.mp3","./assets/sounds/haz-creado-pedido.mp3","./assets/sounds/novedad-creada.mp3","./assets/sounds/chequeo.mp3","./assets/feedback/art-spinning-sticker.gif","./assets/feedback/hands-up-ok-gauss.gif","./assets/stamps/facturado.png","./assets/stamps/entregado.png"];
