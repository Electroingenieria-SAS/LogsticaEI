...
function renderIndicators(){
  ...
  var link='./vsm-dashboard.html?v=129';
  ...
  layout(header("VSM ERP · Estudios de tiempo","Panel liviano. El tablero pesado se separó en un índice independiente para evitar que la app operativa se bloquee.",'<a class="btn btn-primary" href="'+link+'" target="_blank" rel="opener">Abrir VSM optimizado</a>'+(canExportSiesa?'<button class="btn btn-gold" data-action="exportSiesaCuts">Exportar plano SIESA cortes</button>':''))+
    '<section class="notice success"><strong>V129:</strong> el VSM usa tablero independiente tipo Power BI, agrega etiquetas de interpretación para cada indicador y muestra usuarios por nombre real trazado, sin exponer identificadores técnicos en el tablero. Al abrirlo se usa un tablero independiente, liviano y por lotes, con KPIs VSM, lead time por proceso, productividad por usuario consolidado, usuario por proceso, VA, espera, NVA/tiempo muerto, P50/P90, throughput y exportación Excel optimizada. El cálculo pesado queda totalmente aislado de la operación.</section>'+ 
    ...
    '</section>'+ 
    '<section class="card" style="margin-top:16px"><h3>Cómo usarlo</h3><p>Abre el VSM optimizado en una pestaña aparte. El tablero lee Firebase directamente, calcula solo los indicadores necesarios y exporta el informe en lotes. La operación normal de pedidos queda aislada para que Corte, Recepción, Alistamiento, Ventas y Caja no se vean afectados.</p><div class="top-actions"><a class="btn btn-primary" href="'+link+'" target="_blank" rel="opener">Abrir tablero VSM optimizado</a><a class="btn" href="./vsm-dashboard.html?export=1&v=129" target="_blank" rel="opener">Abrir y preparar exportación</a></div></section>'+ 
