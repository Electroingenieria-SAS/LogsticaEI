...
function receptionStickerPrintHtml(stickers,title){
  ...
  var css='@page{size:A4;margin:8mm}*{box-sizing:border-box}body{font-family:Arial,Helvetica,sans-serif;margin:0;color:#0f172a;background:#f4f7fb}.no-print{padding:10px 0;margin:0 0 12px;text-align:center}.no-print button{border:0;border-radius:14px;background:#082a63;color:#fff;font-weight:800;padding:11px 18px;cursor:pointer;box-shadow:0 10px 24px rgba(8,42,99,.18)}.sheet{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8mm}.label{min-height:74mm;border:1px solid #d6dfeb;border-radius:18px;overflow:hidden;background:#fff;display:flex;flex-direction:column;break-inside:avoid;page-break-inside:avoid;box-shadow:0 12px 28px rgba(15,23,42,.08)}.header{display:grid;grid-template-columns:auto 1fr auto;gap:12px;align-items:center;padding:12px 14px;background:linear-gradient(135deg,#082a63 0%,#1f4ea3 100%);color:#fff}.logoWrap{width:56px;height:56px;border-radius:14px;background:#fff;display:flex;align-items:center;justify-content:center;padding:6px;flex:0 0 auto}.logo{max-width:100%;max-height:100%;object-fit:contain}.brandline{font-size:10px;font-weight:800;letter-spacing:.12em;text-transform:uppercase;opacity:.92}.title{font-size:18px;font-weight:900;line-height:1.05;margin-top:3px}.subtitle{font-size:10px;opacity:.9;margin-top:2px}.status{align-self:flex-start;background:#dcfce7;color:#166534;border:1px solid rgba(255,255,255,.35);border-radius:999px;padding:6px 12px;font-size:11px;font-weight:900;white-space:nowrap}.summary{display:grid;grid-template-columns:1.4fr .9fr;gap:10px;padding:12px 14px 10px;border-bottom:1px solid #e2e8f0;background:#fbfdff}.summaryCard{background:#fff;border:1px solid #dce6f4;border-radius:14px;padding:9px 10px;min-height:56px}.summaryCard span{display:block;font-size:9px;text-transform:uppercase;letter-spacing:.1em;color:#64748b;margin-bottom:4px}.summaryCard strong{display:block;font-size:16px;color:#082a63;line-height:1.1;word-break:break-word}.summaryCard small{display:block;font-size:11px;color:#334155;line-height:1.2}.materialBox{margin:12px 14px 10px;padding:11px 12px;border:1px solid #dbe4f0;background:linear-gradient(180deg,#f9fbff 0%,#ffffff 100%);border-radius:16px}.materialBox span{display:block;font-size:9px;text-transform:uppercase;letter-spacing:.1em;color:#64748b;margin-bottom:4px}.materialBox strong{display:block;font-size:16px;line-height:1.2;color:#0f172a;word-break:break-word}.details{display:grid;grid-template-columns:1fr 1fr;gap:9px;padding:0 14px 12px}.cell{border:1px solid #e2e8f0;border-radius:13px;background:#fff;padding:9px 10px;min-height:52px;display:flex;flex-direction:column;justify-content:flex-start}.cell span{display:block;font-size:9px;text-transform:uppercase;letter-spacing:.1em;color:#64748b;margin-bottom:4px}.cell b{display:block;font-size:11px;color:#0f172a;line-height:1.22;word-break:break-word}.footer{margin-top:auto;display:grid;grid-template-columns:1fr auto;gap:12px;align-items:end;padding:10px 14px 12px;border-top:1px dashed #cbd5e1;background:#fcfdff}.metaLine{font-size:9px;color:#64748b;line-height:1.4}.metaLine strong{display:block;font-size:10px;color:#0f172a}.stickerCodeWrap{text-align:right}.stickerCodeWrap span{display:block;font-size:9px;text-transform:uppercase;letter-spacing:.1em;color:#64748b;margin-bottom:4px}.code{display:inline-block;font-family:Consolas,Monaco,monospace;font-size:10px;font-weight:700;color:#082a63;background:#eef4ff;padding:6px 10px;border-radius:999px;border:1px solid #cfe0ff}.note{display:block;margin-top:5px;font-size:9px;color:#475569}@media print{body{background:#fff}.no-print{display:none}.sheet{gap:6mm}.label{box-shadow:none;border-color:#c7d2e3}.header{print-color-adjust:exact;-webkit-print-color-adjust:exact}.status{print-color-adjust:exact;-webkit-print-color-adjust:exact}}';
  var rows=stickers.map(function(st){
    ...
    return '<article class="label">'
      ...
      +'<div class="summary">'
        ...
        +'<div class="summaryCard"><span>Documento de ingreso</span><strong style="font-size:14px">'+esc(st.documentNumber||'')+'</strong><small>Ingreso registrado en recepción</small></div>'
      +'</div>'
